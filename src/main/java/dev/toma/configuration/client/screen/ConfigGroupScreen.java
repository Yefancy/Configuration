...
public class ConfigGroupScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        graphics.drawString(font, this.title, (int) ((this.width - titleWidth) / 2.0F), (int) ((HEADER_HEIGHT - this.font.lineHeight) / 2.0F), 0xFFFFFF);
    ...
    protected static final class LeftAlignedLabel extends AbstractWidget {
        ...
        public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
            graphics.drawString(font, this.getMessage(), this.getX(), (int) (this.getY() + (this.height - this.font.lineHeight) / 2.0F), 0xAAAAAA);
        }
